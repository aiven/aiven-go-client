...
type (
	...
	AccessControl struct {
		...
		DragonflyACLCategories   []string `json:"dragonfly_acl_categories"`
		DragonflyACLCommands     []string `json:"dragonfly_acl_commands"`
		DragonflyACLKeys         []string `json:"dragonfly_acl_keys"`
